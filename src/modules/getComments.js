...
static commentsKeyID = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/gzuVGjybCPx7DImkOsad/comments';
static commentApiEndpoint = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/gzuVGjybCPx7DImkOsad/comments';
...
static getGameData = async (gameID) => {
  ...
  const response = await this.get(`${this.gameAPI}/game?id=${gameID}`, options);
  return response;
};
